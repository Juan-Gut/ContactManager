...
partial class MainForm
{
    ...
    private TextBox EmployeePlzInput = null!;
    ...
    private void InitializeComponent()
    {
        ...
        BuildCustomerView(); BuildEmployeeView();
    ...
    private void BuildCustomerView()
    {
        ...
        CustomerDetailsLayout.Dock = DockStyle.Fill; CustomerDetailsLayout.RowCount = 3; CustomerDetailsLayout.ColumnCount = 1; CustomerDetailsLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 48)); CustomerDetailsLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 100)); CustomerDetailsLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 48));
        ...
        CustomerDetailsLayout.Controls.Add(CustomerDetailsHost, 0, 1); CustomerDetailsLayout.Controls.Add(CustomerEditActions, 0, 2);
    ...
    {
        CustomerNotesView.Dock = DockStyle.Fill; CustomerNotesView.Visible = false; CustomerNotesLayout.Dock = DockStyle.Fill; CustomerNotesLayout.RowCount = 3; CustomerNotesLayout.ColumnCount = 1; CustomerNotesLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100)); CustomerNotesLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 48)); CustomerNotesLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 0)); CustomerNotesLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 100));
        ConfigureButton(BackToCustomerDetails, "Back to details", HideCustomerNotesView); ConfigureButton(AddCustomerNote, "Add note", AddNewCustomerNote); ConfigureButton(SaveCustomerNote, "Save note", SaveNewCustomerNote); ConfigureButton(CancelCustomerNote, "Cancel", CancelNewCustomerNote); SaveCustomerNote.Visible = false; CancelCustomerNote.Visible = false; CustomerNotesActions.Dock = DockStyle.Fill; CustomerNotesActions.Padding = new Padding(8, 8, 4, 4); CustomerNotesActions.Controls.AddRange(new Control[] { BackToCustomerDetails, AddCustomerNote, SaveCustomerNote, CancelCustomerNote }); CustomerNotesLayout.Controls.Add(CustomerNotesActions, 0, 0);
        CustomerNotesSplitView.Dock = DockStyle.Fill; CustomerNotesSplitView.Orientation = Orientation.Horizontal; CustomerNotesSplitView.SplitterDistance = 1; ConfigureGrid(CustomerContactEntriesGrid); CustomerContactEntriesGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill; AddTextColumn(CustomerContactEntriesGrid, "Contact date", "CreatedAt"); AddTextColumn(CustomerContactEntriesGrid, "Note", "Preview"); CustomerContactEntriesGrid.SelectionChanged += SelectCustomerNote; CustomerNotesSplitView.Panel1.Controls.Add(CustomerContactEntriesGrid); CustomerNoteContent.Multiline = true; CustomerNoteContent.ReadOnly = true; CustomerNoteContent.ScrollBars = ScrollBars.Both; CustomerNoteContent.Dock = DockStyle.Fill; CustomerNotesSplitView.Panel2.Controls.Add(CustomerNoteContent); CustomerNotesLayout.Controls.Add(CustomerNotesSplitView, 0, 2); NewCustomerNoteInput.Multiline = true; NewCustomerNoteInput.ScrollBars = ScrollBars.Vertical; NewCustomerNoteInput.Dock = DockStyle.Fill; NewCustomerNoteArea.Dock = DockStyle.Fill; NewCustomerNoteArea.Padding = new Padding(8); NewCustomerNoteArea.Visible = false; NewCustomerNoteArea.Controls.Add(NewCustomerNoteInput); CustomerNotesLayout.Controls.Add(NewCustomerNoteArea, 0, 1); CustomerNotesView.Controls.Add(CustomerNotesLayout); BuildCustomerEditHistory();
    }
    ...
    private void BuildEmployeeView()
    {
        ...
        AddDetailRow(EmployeeDetailsFields, "Title", EmployeeTitleInput, 3); AddDetailRow(EmployeeDetailsFields, "First name", EmployeeFirstNameInput, 4); AddDetailRow(EmployeeDetailsFields, "Last name", EmployeeLastNameInput, 5); AddDetailRow(EmployeeDetailsFields, "Date of birth", EmployeeDateOfBirthInput, 6); AddDetailRow(EmployeeDetailsFields, "Gender", EmployeeGenderInput, 7); AddDetailRow(EmployeeDetailsFields, "Job title", EmployeeJobTitleInput, 8); AddDetailRow(EmployeeDetailsFields, "Business phone", EmployeeBusinessPhoneInput, 9); AddDetailRow(EmployeeDetailsFields, "Mobile phone", EmployeeMobilePhoneInput, 10); AddDetailRow(EmployeeDetailsFields, "Email", EmployeeEmailInput, 11); AddDetailRow(EmployeeDetailsFields, "Department", EmployeeDepartmentInput, 12); AddDetailRow(EmployeeDetailsFields, "AHV number", EmployeeAhvNumberInput, 13); AddDetailRow(EmployeeDetailsFields, "Nationality", EmployeeNationalityInput, 14); AddDetailRow(EmployeeDetailsFields, "Address", EmployeeAddressInput, 15); AddDetailRow(EmployeeDetailsFields, "City", EmployeeCityInput, 16); AddDetailRow(EmployeeDetailsFields, "PLZ", EmployeePlzInput, 17); AddDetailRow(EmployeeDetailsFields, "Employment start date", EmployeeStartDateInput, 18); AddDetailRow(EmployeeDetailsFields, "Employment end date", EmployeeEndDateArea, 19); AddDetailRow(EmployeeDetailsFields, "Employment percentage", EmployeeEmploymentPercentageInput, 20); AddDetailRow(EmployeeDetailsFields, "Office location", EmployeeOfficeLocationInput, 21); AddDetailRow(EmployeeDetailsFields, "Management level", EmployeeManagementLevelInput, 22); AddDetailRow(EmployeeDetailsFields, "Apprenticeship duration", ApprenticeshipDurationInput, 23); AddDetailRow(EmployeeDetailsFields, "Current apprenticeship year", CurrentApprenticeshipYearInput, 24);
        EmployeeDetailsFields.Dock = DockStyle.Fill;
        EmployeeDetailsFields.AutoSize = true;
        EmployeeDetailsTypeDefaults(); EmployeeDetails.Controls.Add(EmployeeDetailsFields); EmployeeDetailsScrollView.Controls.Add(EmployeeDetails); EmployeeDetailsLayout.Controls.Add(EmployeeDetailsScrollView, 0, 1); EmployeeDetailsLayout.Controls.Add(EmployeeEditActions, 0, 2); BuildEmployeeEditHistory();
    ...
    private void EmployeeDetailsTypeDefaults() { EmployeeNumberInput.ReadOnly = true; EmployeeEmploymentPercentageInput.Minimum = 0; EmployeeEmploymentPercentageInput.Maximum = ushort.MaxValue; EmployeeEmploymentPercentageInput.Value = 66; EmployeeDateOfBirthInput.Format = DateTimePickerFormat.Custom; EmployeeDateOfBirthInput.CustomFormat = "dd.MM.yyyy"; EmployeeStartDateInput.Format = DateTimePickerFormat.Custom; EmployeeStartDateInput.CustomFormat = "dd.MM.yyyy"; EmployeeEndDateInput.Format = DateTimePickerFormat.Custom; EmployeeEndDateInput.CustomFormat = " "; EmployeeTitleInput.DropDownStyle = ComboBoxStyle.DropDownList; EmployeeGenderInput.DropDownStyle = ComboBoxStyle.DropDownList; EmployeeOfficeLocationInput.DropDownStyle = ComboBoxStyle.DropDownList; EmployeeManagementLevelInput.DropDownStyle = ComboBoxStyle.DropDownList; ApprenticeshipDurationInput.Minimum = 0; ApprenticeshipDurationInput.Maximum = ushort.MaxValue; CurrentApprenticeshipYearInput.Minimum = 0; CurrentApprenticeshipYearInput.Maximum = ushort.MaxValue; SetApprenticeFieldsVisible(false); }
