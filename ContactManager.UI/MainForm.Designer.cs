...
partial class MainForm
{
    ...
    private void BuildEmployeeView()
    {
        ...
        ConfigureEmployeeTypeSelection(); AddDetailRow(EmployeeDetailsFields, "Employee number", EmployeeNumberInput, 0); AddDetailRow(EmployeeDetailsFields, "Employee type", EmployeeTypeSelection, 1);
        AddDetailRow(EmployeeDetailsFields, "Title", EmployeeTitleInput, 2); AddDetailRow(EmployeeDetailsFields, "First name", EmployeeFirstNameInput, 3); AddDetailRow(EmployeeDetailsFields, "Last name", EmployeeLastNameInput, 4); AddDetailRow(EmployeeDetailsFields, "Date of birth", EmployeeDateOfBirthInput, 5); AddDetailRow(EmployeeDetailsFields, "Gender", EmployeeGenderInput, 6); AddDetailRow(EmployeeDetailsFields, "Job title", EmployeeJobTitleInput, 7); AddDetailRow(EmployeeDetailsFields, "Business phone", EmployeeBusinessPhoneInput, 8); AddDetailRow(EmployeeDetailsFields, "Mobile phone", EmployeeMobilePhoneInput, 9); AddDetailRow(EmployeeDetailsFields, "Email", EmployeeEmailInput, 10); AddDetailRow(EmployeeDetailsFields, "Department", EmployeeDepartmentInput, 11); AddDetailRow(EmployeeDetailsFields, "AHV number", EmployeeAhvNumberInput, 12); AddDetailRow(EmployeeDetailsFields, "Nationality", EmployeeNationalityInput, 13); AddDetailRow(EmployeeDetailsFields, "City", EmployeeCityInput, 14); AddDetailRow(EmployeeDetailsFields, "Address", EmployeeAddressInput, 15); AddDetailRow(EmployeeDetailsFields, "Postal code", EmployeePostalCodeInput, 16); AddDetailRow(EmployeeDetailsFields, "Employment start date", EmployeeStartDateInput, 17); AddDetailRow(EmployeeDetailsFields, "Employment end date", EmployeeEndDateInput, 18); AddDetailRow(EmployeeDetailsFields, "Employment percentage", EmployeeEmploymentPercentageInput, 19); AddDetailRow(EmployeeDetailsFields, "Office location", EmployeeOfficeLocationInput, 20); AddDetailRow(EmployeeDetailsFields, "Management level", EmployeeManagementLevelInput, 21); AddDetailRow(EmployeeDetailsFields, "Apprenticeship duration", ApprenticeshipDurationInput, 22); AddDetailRow(EmployeeDetailsFields, "Current apprenticeship year", CurrentApprenticeshipYearInput, 23);
