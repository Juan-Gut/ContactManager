...
partial class MainForm
{
    ...
    {
        EmployeesSplitView.Dock = DockStyle.Fill; EmployeesSplitView.Orientation = Orientation.Vertical; EmployeesSplitView.IsSplitterFixed = false; EmployeeListLayout.Dock = DockStyle.Fill; EmployeeListLayout.RowCount = 2; EmployeeListLayout.ColumnCount = 1; EmployeeListLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 45)); EmployeeListLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 100)); EmployeeSearchArea.Padding = new Padding(12, 8, 12, 8); EmployeeSearchInput.Dock = DockStyle.Fill; EmployeeSearchInput.PlaceholderText = "Search employees…"; EmployeeSearchInput.TextChanged += SearchEmployees; EmployeeSearchArea.Controls.Add(EmployeeSearchInput); EmployeeListLayout.Controls.Add(EmployeeSearchArea, 0, 0); ConfigureGrid(EmployeesGrid); AddTextColumn(EmployeesGrid, "Title", "Title", 60); foreach (var column in new[] { ("First name", "FirstName"), ("Last name", "LastName"), ("Date of birth", "DateOfBirth"), ("Gender", "Gender"), ("Job title", "JobTitle"), ("Email", "EmailAddress"), ("Business phone", "BusinessNumber"), ("Mobile phone", "MobileNumber"), ("Created at", "CreatedAt"), ("Employee no.", "EmployeeNumber"), ("Department", "Department"), ("AHV number", "AhvNumber"), ("Nationality", "Nationality"), ("City", "City"), ("Address", "Address"), ("Postal code", "Plz"), ("Employment start date", "EmploymentStartDate"), ("Employment end date", "EmploymentEndDate"), ("Employment percentage", "EmploymentPercentage"), ("Office location", "OfficeLocation"), ("Management level", "ManagementLevel"), ("Employee type", "EmployeeType"), ("Apprenticeship duration", "ApprenticeshipDuration"), ("Current apprenticeship year", "CurrentApprenticeshipYear") }) AddTextColumn(EmployeesGrid, column.Item1, column.Item2); EmployeesGrid.SelectionChanged += SelectEmployee; EmployeeListLayout.Controls.Add(EmployeesGrid, 0, 1); EmployeesSplitView.Panel1.Controls.Add(EmployeeListLayout);
        ...
        AddDetailRow(EmployeeDetailsFields, "Employee number", EmployeeNumberInput, 1); AddDetailRow(EmployeeDetailsFields, "Title", EmployeeTitleInput, 2); AddDetailRow(EmployeeDetailsFields, "First name", EmployeeFirstNameInput, 3); AddDetailRow(EmployeeDetailsFields, "Last name", EmployeeLastNameInput, 4); AddDetailRow(EmployeeDetailsFields, "Date of birth", EmployeeDateOfBirthInput, 5); AddDetailRow(EmployeeDetailsFields, "Gender", EmployeeGenderInput, 6); AddDetailRow(EmployeeDetailsFields, "Job title", EmployeeJobTitleInput, 7); AddDetailRow(EmployeeDetailsFields, "Business phone", EmployeeBusinessPhoneInput, 8); AddDetailRow(EmployeeDetailsFields, "Mobile phone", EmployeeMobilePhoneInput, 9); AddDetailRow(EmployeeDetailsFields, "Email", EmployeeEmailInput, 10); AddDetailRow(EmployeeDetailsFields, "Department", EmployeeDepartmentInput, 11); AddDetailRow(EmployeeDetailsFields, "AHV number", EmployeeAhvNumberInput, 12); AddDetailRow(EmployeeDetailsFields, "Nationality", EmployeeNationalityInput, 13); AddDetailRow(EmployeeDetailsFields, "City", EmployeeCityInput, 14); AddDetailRow(EmployeeDetailsFields, "Address", EmployeeAddressInput, 15); AddDetailRow(EmployeeDetailsFields, "Postal code", EmployeePostalCodeInput, 16); AddDetailRow(EmployeeDetailsFields, "Employment start date", EmployeeStartDateInput, 17); AddDetailRow(EmployeeDetailsFields, "Employment end date", EmployeeEndDateInput, 18); AddDetailRow(EmployeeDetailsFields, "Employment percentage", EmployeeEmploymentPercentageInput, 19); AddDetailRow(EmployeeDetailsFields, "Office location", EmployeeOfficeLocationInput, 20); AddDetailRow(EmployeeDetailsFields, "Management level", EmployeeManagementLevelInput, 21); AddDetailRow(EmployeeDetailsFields, "Apprenticeship duration", ApprenticeshipDurationInput, 22); AddDetailRow(EmployeeDetailsFields, "Current apprenticeship year", CurrentApprenticeshipYearInput, 23);
